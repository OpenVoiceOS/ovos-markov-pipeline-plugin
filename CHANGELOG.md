...
- fix: pass skill\_id kwarg to ovoscope.register\_padatious\_intent in e2e test [\#15](https://github.com/OpenVoiceOS/ovos-markov-pipeline-plugin/pull/15) ([JarbasAl](https://github.com/JarbasAl))
